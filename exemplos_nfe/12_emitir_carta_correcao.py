...
if __name__ == '__main__':
    ...
    resultados = nova_nfe.emitir_carta_correcao(chave=chave, texto_correcao=texto_correcao, sequencia=sequencia, cert=info_certificado['cert'], key=info_certificado['key'], versao=u'3.10', ambiente=2, estado=u'MG', tipo_contingencia=False)
